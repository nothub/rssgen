...
public class AllElements {
    ...
    public static void main(String[] args) throws MalformedURLException, URISyntaxException {
        ...
        rss.addItem()
            ...
            .category("backissues", "https://scriptingnews.userland.com/backissues")
            .guid("http://scriptingnews.userland.com/backissues/2002/09/29#reallyEarlyMorningNocoffeeNotes", true)
        ...
        rss.writeFile(new File("rss.xml"), 2);
